...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo my_site_url(CTL_FOLDER.'bot_nav');?>">底部导航</a> &gt; 添加导航 </td>
  </tr>
</table>
<fieldset>
...
<fieldset>
  ...
  <form action="<?php echo my_site_url(CTL_FOLDER.'bot_nav/add_record');?>" method="post">
