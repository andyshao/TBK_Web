...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo my_site_url(CTL_FOLDER.'top_nav');?>">顶部导航</a> &gt; 添加导航 </td>
  </tr>
</table>
<fieldset>
...
<fieldset>
  ...
  <form action="<?php echo my_site_url(CTL_FOLDER.'top_nav/add_record');?>" method="post">
    <table width="100%"  border="0" cellpadding="3" cellspacing="0" style="margin:10px 0">
      <tr>
        ...
        <td width="594"><font style="color:#FF0000">链接可从第一步中生成，也可以直接填写链接，站外链接开头需加上"http://"</font><br />
          <input type="text" size="60" maxlength="255" name="hplink" dataType="Require" msg="该项必填" /></td>
      </tr>
      <tr>
        <td width="119"><font color="#FF0000">*</font>导航名称：</td>
        <td width="594"><input name="title" id="title" type="text" size="15" dataType="Require" msg="该项必须填写" maxlength="30" /></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="119">&nbsp;</td>
        <td width="594"><input type="button" onClick="subForm(this.form,this)" value="添加" class="button-style" /></td>
      </tr>
    </table>
  </form>
</fieldset>
