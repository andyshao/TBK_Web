...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo site_url(CTL_FOLDER."bot_nav");?>">底部导航</a></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0;">
  <tr>
    <td width="390" height="24" align="right" ><a href="<?php echo my_site_url(CTL_FOLDER.'bot_nav/add_record_view');?>"><img src="{tpl_path}images/add.png">添加导航</a></td>
    <td width="367" align="right"  style="padding-right:10px"><a href="<?php echo my_site_url(CTL_FOLDER.'bot_nav/re_cache');?>"><img src="{tpl_path}images/refresh.jpg"  /> 更新缓存</a></td>
  </tr>
</table>
  ...
  <table width="100%" cellspacing="0" class="widefat">
    ...
    <tbody id="check_box_id">
      ...
      <tr>
        ...
        <td><a href="<?php echo site_url(CTL_FOLDER."bot_nav/edit_record/".$row->id);?>">修改</a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td style="padding-top:5px"><select name="action_url" id="action_url">
          ...
          <option value="<?php echo site_url(CTL_FOLDER."bot_nav/del_record");?>">删除</option>
          <option value="<?php echo site_url(CTL_FOLDER."bot_nav/sort_record");?>">排序</option>
        </select>
        &nbsp;
